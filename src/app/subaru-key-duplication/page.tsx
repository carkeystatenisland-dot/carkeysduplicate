...
export const metadata = generatePageMetadata({
  title: `Subaru Car Key duplicate NYC | Mobile Locksmith Service`,
  description: `Expert mobile Subaru car key duplicate across NYC. We cut and program OEM-grade transponders, smart keys, and fobs on-site.`,
  slug: `subaru-key-duplicate`
})
    ...
    <div className="pb-16 bg-white">
      ...
      <div className="bg-brand-primary text-white py-16 md:py-24 px-4 text-center border-b-4 border-brand-accent">
        <div className="max-w-4xl mx-auto">
          <h1 className="text-4xl md:text-5xl lg:text-6xl font-heading font-extrabold mb-6 leading-tight">Subaru Car Key duplicate NYC</h1>
      ...
      <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 mt-16">
        ...
        <article className="prose prose-lg max-w-none text-gray-700 mb-16">
          ...
          <p>
            ...
            automotive locksmith service exists. We provide on-site Subaru car key duplicate, transponder key programming, and smart key fob 
        ...
        <div className="mb-16">
          ...
          <div className="space-y-6">
            <div>
              <h4 className="font-bold text-lg text-gray-800 mb-2">How much does a Subaru key duplicate cost?</h4>
