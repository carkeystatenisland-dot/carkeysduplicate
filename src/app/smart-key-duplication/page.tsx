...
export const metadata = generatePageMetadata({
  title: `Smart Key Duplication NYC | Mobile, On-Site Programming`,
  description: `Expert smart key duplication across all NYC boroughs. We come to your location with OEM-grade diagnostic tools to program your vehicle securely.`,
    ...
    <div className="pb-16 bg-white">
      <div className="bg-brand-primary text-white py-16 md:py-24 px-4 text-center border-b-4 border-brand-accent">
        <div className="max-w-4xl mx-auto">
          <h1 className="text-4xl md:text-5xl lg:text-6xl font-heading font-extrabold mb-6 leading-tight">Smart Key Duplication in NYC</h1>
      ...
      <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 mt-16">
        <div className="mb-16">
          ...
          <div className="bg-gray-50 p-8 rounded-2xl border border-gray-200 shadow-sm leading-relaxed text-lg text-gray-700">
            <p className="mb-6">Smart keys (or proximity keys) represent the height of modern vehicle convenience. These fobs constantly emit a low-frequency signal. When you touch the door handle or press the start button, the vehicle's internal antennas triangulate the key's exact position. If it detects the authorized key inside the cabin, it authenticates the start.</p>
            <p className="font-semibold text-brand-primary">Smart key systems are integrated with your car's Body Control Module (BCM). A mistake here can immobilize the entire car. We carry redundant programming units to ensure a safe, 'read-only' diagnostic check before writing any data.</p>
          </div>
        </div>
        ...
        <div className="mt-12 pt-12 border-t border-gray-200">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
            <Link href="/brooklyn" className="flex items-center gap-2 text-gray-700 hover:text-brand-accent transition-colors"><MapPin className="w-4 h-4 text-brand-accent" /> Smart Key Duplication in Brooklyn</Link>
            <Link href="/queens" className="flex items-center gap-2 text-gray-700 hover:text-brand-accent transition-colors"><MapPin className="w-4 h-4 text-brand-accent" /> Smart Key Duplication in Queens</Link>
            <Link href="/manhattan" className="flex items-center gap-2 text-gray-700 hover:text-brand-accent transition-colors"><MapPin className="w-4 h-4 text-brand-accent" /> Smart Key Duplication in Manhattan</Link>
            <Link href="/bronx" className="flex items-center gap-2 text-gray-700 hover:text-brand-accent transition-colors"><MapPin className="w-4 h-4 text-brand-accent" /> Smart Key Duplication in The Bronx</Link>
            <Link href="/staten-island" className="flex items-center gap-2 text-gray-700 hover:text-brand-accent transition-colors"><MapPin className="w-4 h-4 text-brand-accent" /> Smart Key Duplication in Staten Island</Link>
          </div>
        </div>
