    ...
    <div className="pb-16 bg-white">
      ...
      <div className="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8 mt-16">
        ...
        <div className="prose prose-lg max-w-none text-gray-700 mb-16">
          <h2 className="text-3xl font-heading text-brand-primary font-bold">Why Mobile Locksmith Service Matters in Brooklyn</h2>
          <div className="bg-white p-8 rounded-2xl shadow-sm border border-gray-200 mt-6">
            <p className="text-lg leading-relaxed mb-6">
              Brooklyn's alternate side parking rules mean a lost key isn't just an inconvenience—it's a race against a parking ticket.
            </p>
            <p className="text-lg leading-relaxed">
              We understand that navigating tight Brooklyn streets requires a nimble mobile response. Whether you are stuck in a residential driveway in Bensonhurst or a pay-by-the-hour lot in Williamsburg, our mobile locksmith vans bring dealership-level programming equipment directly to your vehicle.
            </p>
          </div>
        </div>
        ...
        <div className="mb-16">
          ...
          <div className="grid grid-cols-2 sm:grid-cols-3 md:grid-cols-4 gap-3">
            <div className="bg-gray-50 border border-gray-200 py-3 px-4 rounded-lg text-sm font-medium text-center text-gray-700">Williamsburg</div><div className="bg-gray-50 border border-gray-200 py-3 px-4 rounded-lg text-sm font-medium text-center text-gray-700">Park Slope</div><div className="bg-gray-50 border border-gray-200 py-3 px-4 rounded-lg text-sm font-medium text-center text-gray-700">Bay Ridge</div><div className="bg-gray-50 border border-gray-200 py-3 px-4 rounded-lg text-sm font-medium text-center text-gray-700">Bensonhurst</div><div className="bg-gray-50 border border-gray-200 py-3 px-4 rounded-lg text-sm font-medium text-center text-gray-700">Flatbush</div><div className="bg-gray-50 border border-gray-200 py-3 px-4 rounded-lg text-sm font-medium text-center text-gray-700">Canarsie</div><div className="bg-gray-50 border border-gray-200 py-3 px-4 rounded-lg text-sm font-medium text-center text-gray-700">Crown Heights</div><div className="bg-gray-50 border border-gray-200 py-3 px-4 rounded-lg text-sm font-medium text-center text-gray-700">Bed-Stuy</div>
          </div>
        </div>
        ...
        <div className="mt-12 pt-12 border-t border-gray-200">
          <h2 className="text-2xl font-bold text-brand-primary mb-6">Our Services in Brooklyn</h2>
          ...
          <h3 className="text-xl font-bold text-brand-primary mt-10 mb-4">Popular Vehicle Makes Serviced in Brooklyn</h3>
