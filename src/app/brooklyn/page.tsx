      ...
      <div className="max-w-4xl mx-auto px-4 mt-12">
        <div className="prose prose-lg max-w-none text-gray-700">
          ...
          <div className="mt-12 pt-8 border-t border-gray-200">
            <h2 className="text-2xl font-bold mb-6">Our Services in Brooklyn</h2>
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
              <Link href="/transponder-key-duplication" className="text-brand-accent hover:underline">Transponder Key Duplication in Brooklyn</Link>\n              <Link href="/key-fob-duplication" className="text-brand-accent hover:underline">Key Fob Duplication in Brooklyn</Link>\n              <Link href="/smart-key-duplication" className="text-brand-accent hover:underline">Smart Key Duplication in Brooklyn</Link>\n              <Link href="/push-to-start-key-duplication" className="text-brand-accent hover:underline">Push-to-Start Key Duplication in Brooklyn</Link>\n              <Link href="/laser-cut-key-duplication" className="text-brand-accent hover:underline">Laser-Cut Key Duplication in Brooklyn</Link>\n              <Link href="/spare-key-copy" className="text-brand-accent hover:underline">Spare Key Copy in Brooklyn</Link>
            </div>

            <h3 className="text-xl font-bold mt-8 mb-4">Popular Vehicle Makes Serviced in Brooklyn</h3>
