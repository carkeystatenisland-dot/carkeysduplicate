      ...
      <div className="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8 mt-16">
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8 mb-16">
          <div className="bg-brand-light p-6 rounded-xl border border-gray-100 flex flex-col items-center text-center">
            ...
            <p className="text-gray-600 text-sm">We navigate Brooklyn traffic efficiently, arriving at your exact location usually within 30-60 minutes.</p>
          </div>
          <div className="bg-brand-light p-6 rounded-xl border border-gray-100 flex flex-col items-center text-center">
        ...
        <div className="prose prose-lg max-w-none text-gray-700 mb-16">
          <h2 className="text-3xl font-heading text-brand-primary font-bold underline decoration-brand-accent underline-offset-8">Why Mobile Locksmith Service Matters in Brooklyn</h2>
          <div className="bg-white p-8 rounded-2xl shadow-sm border border-gray-200 mt-10">
            <p className="text-lg leading-relaxed mb-6">Brooklyn's alternate side parking rules mean a lost key isn't just an inconvenience—it's a race against a parking ticket.</p>
            <p className="text-lg leading-relaxed">We understand that navigating tight Brooklyn streets requires a nimble mobile response. Whether you are stuck in a residential driveway in Bensonhurst or a pay-by-the-hour lot in Williamsburg, our mobile locksmith vans bring dealership-level programming equipment directly to your vehicle.</p>
          </div>
        </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-8 mb-16">
          <div className="bg-red-50 p-8 rounded-2xl border border-red-100">
            <h3 className="text-xl font-bold text-red-900 mb-4 flex items-center gap-2">
              <AlertTriangle className="w-6 h-6 text-red-600" /> Brooklyn Locksmith Scam Alert
            </h3>
            <p className="text-red-800 leading-relaxed">In Brooklyn, 'ghost locksmiths' often quote $15 on the phone and demand $500 on-site. We provide a firm quote based on your VIN before we even start our engine.</p>
          </div>
          <div className="bg-blue-50 p-8 rounded-2xl border border-blue-100">
            <h3 className="text-xl font-bold text-blue-900 mb-4 flex items-center gap-2">
              <BarChart3 className="w-6 h-6 text-blue-600" /> Local Service Data
            </h3>
            <p className="text-blue-800 leading-relaxed">Brooklyn has the highest rate of 'locked out while running' incidents in NYC due to the high density of street parking and quick errands.</p>
          </div>
        </div>

        <div className="mb-16">
          <h2 className="text-2xl font-heading text-brand-primary font-bold mb-6 flex items-center gap-2">
            <MapPin className="w-6 h-6 text-brand-accent" /> Neighborhoods We Serve in Brooklyn
          </h2>
          <div className="grid grid-cols-2 sm:grid-cols-3 md:grid-cols-4 gap-3 text-sm font-medium text-gray-700">
            <div className="bg-gray-50 border border-gray-200 py-3 px-4 rounded-lg text-center hover:bg-brand-light transition-colors">Williamsburg</div><div className="bg-gray-50 border border-gray-200 py-3 px-4 rounded-lg text-center hover:bg-brand-light transition-colors">Park Slope</div><div className="bg-gray-50 border border-gray-200 py-3 px-4 rounded-lg text-center hover:bg-brand-light transition-colors">Bay Ridge</div><div className="bg-gray-50 border border-gray-200 py-3 px-4 rounded-lg text-center hover:bg-brand-light transition-colors">Bensonhurst</div><div className="bg-gray-50 border border-gray-200 py-3 px-4 rounded-lg text-center hover:bg-brand-light transition-colors">Flatbush</div><div className="bg-gray-50 border border-gray-200 py-3 px-4 rounded-lg text-center hover:bg-brand-light transition-colors">Canarsie</div><div className="bg-gray-50 border border-gray-200 py-3 px-4 rounded-lg text-center hover:bg-brand-light transition-colors">Crown Heights</div><div className="bg-gray-50 border border-gray-200 py-3 px-4 rounded-lg text-center hover:bg-brand-light transition-colors">Bed-Stuy</div>
          </div>
        </div>

        <div className="bg-gray-100 p-10 rounded-3xl mb-16 border border-gray-200">
          <h2 className="text-3xl font-bold text-brand-primary mb-8 text-center">Comprehensive Key Solutions in Brooklyn</h2>
        ...
        <div className="mb-16">
          ...
          <div className="bg-white p-8 rounded-xl border border-gray-200 shadow-sm">
            <h3 className="font-bold text-lg text-brand-primary mt-0 mb-3">Can you cut a key if my car is parked on a busy Brooklyn street?</h3>
            <p className="text-gray-600 mb-0 leading-relaxed">Absolutely. Our vans are fully self-contained with power and cutting machines. We simply park nearby and perform the programming right at your vehicle.</p>
          </div>
        </div>
        ...
        <CTABanner title="Stranded in Brooklyn? We're on our way." subtitle="Book online or call us now for immediate, professional dispatch." />
      </div>
    </div>
  )
}