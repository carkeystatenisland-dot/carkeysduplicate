    ...
    <div className="pb-16">
      ...
      <div className="max-w-4xl mx-auto px-4 mt-12">
        <div className="prose prose-lg max-w-none text-gray-700">
          ...
          <p>Our technicians carry specialized programming equipment required for Toyota vehicles, ensuring your new key is correctly synced with the immobilizer.</p>
        </div>
