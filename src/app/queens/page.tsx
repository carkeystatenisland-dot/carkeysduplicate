      ...
      <div className="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8 mt-16">
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8 mb-16">
          <div className="bg-brand-light p-6 rounded-xl border border-gray-100 flex flex-col items-center text-center">
            ...
            <p className="text-gray-600 text-sm">We navigate Queens traffic efficiently, arriving at your exact location usually within 30-60 minutes.</p>
          </div>
          <div className="bg-brand-light p-6 rounded-xl border border-gray-100 flex flex-col items-center text-center">
        ...
        <div className="prose prose-lg max-w-none text-gray-700 mb-16">
          <h2 className="text-3xl font-heading text-brand-primary font-bold underline decoration-brand-accent underline-offset-8">Why Mobile Locksmith Service Matters in Queens</h2>
          <div className="bg-white p-8 rounded-2xl shadow-sm border border-gray-200 mt-10">
            <p className="text-lg leading-relaxed mb-6">With limited subway access in eastern Queens, your car is your lifeline. A lost key brings your entire day to a halt.</p>
            <p className="text-lg leading-relaxed">Queens has the highest number of registered vehicles in NYC. We've optimized our dispatch routes to reach deep into neighborhoods like Bayside, Jamaica, and Flushing in record time. We also specialize in rapid response for travelers stranded at JFK or LaGuardia airports who have lost their keys during transit.</p>
          </div>
        </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-8 mb-16">
          <div className="bg-red-50 p-8 rounded-2xl border border-red-100">
            <h3 className="text-xl font-bold text-red-900 mb-4 flex items-center gap-2">
              <AlertTriangle className="w-6 h-6 text-red-600" /> Queens Locksmith Scam Alert
            </h3>
            <p className="text-red-800 leading-relaxed">Queens residents are often targeted by bait-and-switch locksmiths near airport terminals. Always verify the van branding matches the company you called.</p>
          </div>
        ...
        <div className="mb-16">
          <h2 className="text-2xl font-heading text-brand-primary font-bold mb-6 flex items-center gap-2">
            <MapPin className="w-6 h-6 text-brand-accent" /> Neighborhoods We Serve in Queens
          </h2>
          <div className="grid grid-cols-2 sm:grid-cols-3 md:grid-cols-4 gap-3 text-sm font-medium text-gray-700">
            <div className="bg-gray-50 border border-gray-200 py-3 px-4 rounded-lg text-center hover:bg-brand-light transition-colors">Astoria</div><div className="bg-gray-50 border border-gray-200 py-3 px-4 rounded-lg text-center hover:bg-brand-light transition-colors">Long Island City</div><div className="bg-gray-50 border border-gray-200 py-3 px-4 rounded-lg text-center hover:bg-brand-light transition-colors">Flushing</div><div className="bg-gray-50 border border-gray-200 py-3 px-4 rounded-lg text-center hover:bg-brand-light transition-colors">Jamaica</div><div className="bg-gray-50 border border-gray-200 py-3 px-4 rounded-lg text-center hover:bg-brand-light transition-colors">Bayside</div><div className="bg-gray-50 border border-gray-200 py-3 px-4 rounded-lg text-center hover:bg-brand-light transition-colors">Forest Hills</div><div className="bg-gray-50 border border-gray-200 py-3 px-4 rounded-lg text-center hover:bg-brand-light transition-colors">Jackson Heights</div><div className="bg-gray-50 border border-gray-200 py-3 px-4 rounded-lg text-center hover:bg-brand-light transition-colors">Corona</div>
          </div>
        </div>

        <div className="bg-gray-100 p-10 rounded-3xl mb-16 border border-gray-200">
          <h2 className="text-3xl font-bold text-brand-primary mb-8 text-center">Comprehensive Key Solutions in Queens</h2>
        ...
        <div className="mb-16">
          ...
          <div className="bg-white p-8 rounded-xl border border-gray-200 shadow-sm">
            <h3 className="font-bold text-lg text-brand-primary mt-0 mb-3">Do you service the parking garages at JFK and LaGuardia?</h3>
            <p className="text-gray-600 mb-0 leading-relaxed">Yes, we frequently dispatch technicians to airport parking facilities to assist returning travelers who have lost their car keys.</p>
          </div>
        </div>
        ...
        <CTABanner title="Stranded in Queens? We're on our way." subtitle="Book online or call us now for immediate, professional dispatch." />
      </div>
    </div>
  )
}