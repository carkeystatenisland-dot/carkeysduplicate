    ...
    <div className="pb-16">
      ...
      <div className="max-w-4xl mx-auto px-4 mt-12">
        <div className="prose prose-lg max-w-none text-gray-700">
          <h2>Car Key Services in The Bronx</h2>
          <p>We provide full mobile service throughout The Bronx. Instead of towing your vehicle or waiting at a dealership, our fully-equipped vans come directly to your location to cut and program your key.</p>
        </div>
