...
export const metadata = generatePageMetadata({
  title: 'About Us | car key duplicate NYC',
    ...
    <div className="bg-white min-h-screen py-16">
      <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="prose prose-lg max-w-none text-gray-700 mb-16">
          <h2>Our Mission</h2>
          <p>
            We founded car key duplicate with one simple goal: to eliminate the stress, cost, and waiting times associated with replacing or duplicating car keys at a traditional dealership. In a fast-paced city like New York, you don't have days to wait for a new key, and you certainly don't want to pay exorbitant towing fees just to get your vehicle to a service center.
          </p>
          <p>
