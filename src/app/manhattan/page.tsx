...
export const metadata = generatePageMetadata({
  title: `Car Key duplicate Manhattan NYC | Mobile Service, We Come To You`,
  description: `Expert mobile car key duplicate in Manhattan. We program transponders, smart keys, and fobs on-site. Save time and avoid dealership towing fees.`,
  slug: `manhattan`
})
      ...
      <div className="bg-brand-primary text-white py-16 md:py-24 px-4 text-center border-b-4 border-brand-accent">
        <div className="max-w-4xl mx-auto">
          ...
          <h1 className="text-4xl md:text-5xl lg:text-6xl font-heading font-extrabold mb-6 leading-tight">
            Mobile Car Key duplicate in Manhattan, NYC
          </h1>
      ...
      <div className="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8 mt-16">
        ...
        <div className="mt-12 pt-12 border-t border-gray-200">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
            <Link href="/transponder-key-duplicate" className="flex items-center gap-2 text-gray-700 hover:text-brand-accent transition-colors"><CheckCircle2 className="w-4 h-4 text-brand-accent" /> Transponder Key duplicate in Manhattan</Link>
            <Link href="/key-fob-duplicate" className="flex items-center gap-2 text-gray-700 hover:text-brand-accent transition-colors"><CheckCircle2 className="w-4 h-4 text-brand-accent" /> Key Fob duplicate in Manhattan</Link>
            <Link href="/smart-key-duplicate" className="flex items-center gap-2 text-gray-700 hover:text-brand-accent transition-colors"><CheckCircle2 className="w-4 h-4 text-brand-accent" /> Smart Key duplicate in Manhattan</Link>
            <Link href="/push-to-start-key-duplicate" className="flex items-center gap-2 text-gray-700 hover:text-brand-accent transition-colors"><CheckCircle2 className="w-4 h-4 text-brand-accent" /> Push-to-Start Key duplicate in Manhattan</Link>
            <Link href="/laser-cut-key-duplicate" className="flex items-center gap-2 text-gray-700 hover:text-brand-accent transition-colors"><CheckCircle2 className="w-4 h-4 text-brand-accent" /> Laser-Cut Key duplicate in Manhattan</Link>
