    ...
    <div className="pb-16 bg-white">
      ...
      <div className="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8 mt-16">
        ...
        <div className="prose prose-lg max-w-none text-gray-700 mb-16">
          <h2 className="text-3xl font-heading text-brand-primary font-bold">Why Mobile Locksmith Service Matters in Manhattan</h2>
          <div className="bg-white p-8 rounded-2xl shadow-sm border border-gray-200 mt-6">
            <p className="text-lg leading-relaxed mb-6">
              A car stranded in a Manhattan parking garage accrues massive hourly fees while you wait days for a dealership appointment.
            </p>
        ...
        <div className="mb-16">
          ...
          <div className="grid grid-cols-2 sm:grid-cols-3 md:grid-cols-4 gap-3">
            <div className="bg-gray-50 border border-gray-200 py-3 px-4 rounded-lg text-sm font-medium text-center text-gray-700">Upper East Side</div><div className="bg-gray-50 border border-gray-200 py-3 px-4 rounded-lg text-sm font-medium text-center text-gray-700">Upper West Side</div><div className="bg-gray-50 border border-gray-200 py-3 px-4 rounded-lg text-sm font-medium text-center text-gray-700">Midtown</div><div className="bg-gray-50 border border-gray-200 py-3 px-4 rounded-lg text-sm font-medium text-center text-gray-700">Financial District</div><div className="bg-gray-50 border border-gray-200 py-3 px-4 rounded-lg text-sm font-medium text-center text-gray-700">Chelsea</div><div className="bg-gray-50 border border-gray-200 py-3 px-4 rounded-lg text-sm font-medium text-center text-gray-700">Harlem</div><div className="bg-gray-50 border border-gray-200 py-3 px-4 rounded-lg text-sm font-medium text-center text-gray-700">Washington Heights</div><div className="bg-gray-50 border border-gray-200 py-3 px-4 rounded-lg text-sm font-medium text-center text-gray-700">Greenwich Village</div>
          </div>
        </div>
        ...
        <div className="mt-12 pt-12 border-t border-gray-200">
          <h2 className="text-2xl font-bold text-brand-primary mb-6">Our Services in Manhattan</h2>
          ...
          <h3 className="text-xl font-bold text-brand-primary mt-10 mb-4">Popular Vehicle Makes Serviced in Manhattan</h3>
