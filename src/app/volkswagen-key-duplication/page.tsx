...
export const metadata = generatePageMetadata({
  ...
  slug: `volkswagen-key-duplication`
})
    ...
    <div className="pb-16 bg-white">
      ...
      <div className="bg-brand-primary text-white py-16 md:py-24 px-4 text-center border-b-4 border-brand-accent">
        <div className="max-w-4xl mx-auto">
          <h1 className="text-4xl md:text-5xl lg:text-6xl font-heading font-extrabold mb-6 leading-tight">Volkswagen Car Key Duplication NYC</h1>
